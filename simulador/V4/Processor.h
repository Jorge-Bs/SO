...
//V2 ej2-A INTERRUPT_MASKED_BIT=15
...
int Processor_GetRegisterD(); //Ejercicio v2-ej5-d

enum EXCEPTIONS {DIVISIONBYZERO, INVALIDPROCESSORMODE, INVALIDADDRESS, INVALIDINSTRUCTION}; //V4-Ej1-a
